...
pub use cluster::{
    ...
    test_inject_dest_node_failures, ClusterState, DestNodeInjectGuard, MigrateKeyInjectGuard,
    MigrateSlotError, MigrateSlotResult, ReshardSlotResult, DEFAULT_NODE_TIMEOUT_MS, SLOT_COUNT,
};
pub use hashmap::{
